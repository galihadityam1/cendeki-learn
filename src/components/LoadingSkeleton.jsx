      ...
      <div className="border-primary mt-4 rounded-lg border">
        <Skeleton className="relative flex min-h-60 items-center justify-center rounded-md py-8">
          ...
          <div className="absolute flex flex-col items-center gap-2">
            <p className="text-2xl font-bold text-blue-300">Generating</p>
            <p className="max-w-xs text-center text-sm text-blue-200">
              AI generation may take up to 1 minute. Please wait...
            </p>
          </div>
        </Skeleton>
