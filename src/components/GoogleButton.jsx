...
export const GoogleButton = () => {
  return (
    <button
      className="flex w-full items-center justify-center gap-4 rounded-xl border border-slate-700 bg-slate-800 px-4 py-3.5 text-sm font-bold shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:border-slate-600 hover:bg-slate-700 active:scale-[0.98]"
      onClick={async () =>
