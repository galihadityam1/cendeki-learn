...
export const GoogleButton = () => {
    return (
        <button
            className="flex w-full justify-center gap-5 rounded bg-white px-4 py-4 text-sm font-bold drop-shadow-md hover:bg-gray-50 border hover:translate-x-1 hover:-translate-y-1"
